          ...
          <form action="<?= base_url('order/3') ?>" method="post">
            ...
            <div class="row align-items-center mt-3">
              <div class="col">
                ...
                <input name="harga" type="hidden" class="form-control" placeholder="Contoh : Jack Dawson S.Kom" value="<?php if(isset($_SESSION['harga'])) { echo $_SESSION['harga']; } else { echo $harga; }?>" required>
