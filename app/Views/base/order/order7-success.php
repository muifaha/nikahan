                  ...
                  <div class="row">
                    <div class="col">
                     <?php if($status == 2){ ?>
					  ...
					  <?php }else{ ?> 
					  <a href="#" class="btn btn-primary btn-order btn-block">Review Undangan</a>
					  <?php } ?>
                    </div>
...
mohon infonya " ?> 
            ...
            <div class="form-check mt-4" style="text-align: center;" >
              <h3 class="form-check-label" <?php if($status == 2)echo "style='display:none'" ?>>
                  Untuk melakukan aktifasi silahkan login dengan email dan password yang anda buat atau bisa menghubungi admin via <a href="https://wa.me/+6289667771377/?text=<?php echo urlencode($format) ?>"  >Whtasapp</a> dengan menyertakan <strong>kode :<h2 style="color:red; size:30px; text:bold;">#<?= $kode ?></h2></strong>.
              </h3>
            </div>
