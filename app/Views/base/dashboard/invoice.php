...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        ...
        <?php } 
         else if($pembayaran[0]->id_user != 1) {
...
if($pembayaran[0]->status == 2 && $setting[0]->aktif <= 0 || $today >= $tglNonaktif){ 
        ?>
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold " style="color:red">Invoice : Masa aktif undangan anda sudah habis pada tanggal <?= $tglNonaktifFormated ?>, Silahkan melakukan pembayaran lagi untuk mengaktifkan.</h6>
                    </div>
                    </div>
                    </div>
                    <?php }} ?>
                        ...
                        <div class="upload-area-bg" style="margin-top: 5px;text-align: center;background: #f1f2f6; !important;">                       
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                    <?php if($pembayaran[0]->id_user != 1 && $pembayaran[0]->status == 2 && $today >= $tglNonaktif){ ?>
