...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up"><a href="" class="typewrite judul" data-period="2000"
                            data-type='[ "Undangancnk.online", "Digital Invitation", "Kirim Undangan..", "Desain Unik..", "Mudah diatur.."]'>
    ...
    <main id="main">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4">
                        <div class="box" data-aos="fade-up" data-aos-delay="200">
                            <img src="<?php echo base_url() ?>/assets/base/img/icons/chat.png" height="150px" class="" alt="">
                            <h3>Doa dan Ucapan</h3>
                            <p>Para tamu dapat memberikan doa dan ucapan langsung di website-mu.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        <div class="box" data-aos="fade-up" data-aos-delay="400">
                            <img src="<?php echo base_url() ?>/assets/base/img/icons/book.png" height="150px" class="" alt="" >
                            <h3>Cerita</h3>
                            <p>Tuangkan cerita perjalanan cinta anda kepada tamu undangan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        <div class="box" data-aos="fade-up" data-aos-delay="600">
                            <img src="<?php echo base_url() ?>/assets/base/img/icons/blogger.png" height="150px" class="" alt="">
                            <h3>Layar Sapa</h3>
                            <p>Tampilan yang menarik dan responsive menyapa tamu undangan.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up">
                        <div class="service-box orange">
                            <i class="ri-bank-card-fill icon"></i>
                            <h3>Rp. <?= number_format($setting[0]->harga); ?></h3>
                            <p>Aktif <?= $setting[0]->aktif; ?> Hari</p>
                            <a href="#tema" class="read-more"><span>Order</span> <i
        ...
        <section id="tema" class="tema">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="justify-content-center" data-aos="fade-left">
                        <p class="col-md-12 text-center" style="padding:20px"><a href="<?= base_url() ?>/tema#tema" class="btn btn-primary">Lihat Semua</a></p>
                </div>
            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="<?php echo base_url() ?>/assets/users/<?= $row->kunci ?>/kita.png"
                                        class="testimonial-img" alt="">
                                    <h3><?= $row->nama_lengkap ?></h3>
                                    <h4><?= $row->kota ?>,<?= $row->provinsi ?></h4>
                                </div>
                            </div>
    ...
    <footer id="footer" class="footer">
        <div class="container">
            <div class="copyright">
                Copyright &#169; 2020  UndanganCnk . All Rights Reserved
            </div>
        </div>
    </footer><!-- End Footer -->
