...
<head>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/greenflower/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/greenflower/css/jquery.fancybox.css" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/greenflower/mdi/css/materialdesignicons.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/greenflower/css/style.css">
...
<div class="blocked_message" style="display: flex;justify-content: center;align-items: center;height: 100vh;flex-direction: column;position:absolute;top:0;bottom:0;left:0;right:0;">
	...
	<a style="font-weight: bold;font-size: 13px;color: #34495e;text-align:center;">Segera lakukan pembayaran agar undangan anda bisa aktif!</a>
</div>	
...
<div class="thebegining">
	...
	<div class="salam">
        ...
        ?></a><br>
		<a style="font-weight: normal;font-size:18px;color: #2f3640;font-family: sans-serif;">We invite You to attend our wedding</a>	
	</div>
