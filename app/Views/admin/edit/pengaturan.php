...
<div class="col-xl-6 col-lg-6 mb-4">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <label style="bottom: -12.3px;position: inherit;padding-left: 15px;color: #3498db;font-weight: bold;display: table;margin-bottom: -2.1rem;">u.ngulemind.online/</label>
